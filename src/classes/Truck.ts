...
class Truck extends Vehicle {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    //create new variable and initialize to unknown
    let vehicleMake = 'unknown make';
    let vehicleModel = 'unknown model';
    //check to see if make and model exist then if they do assign make and model to new variables
    if (typeof vehicle.make !== 'undefined' && typeof vehicle.model !== 'undefined') {
